...
class AddressGenerationTests: XCTestCase {
    ...
    func testBitcoinAddressFromPrivateKeyGeneration() {
        let privateKey = try! PrivateKey(pk: "L35qaFLpbCc9yCzeTuWJg4qWnTs9BaLr5CDYcnJ5UnGmgLo8JBgk", coin: .bitcoin)
    ...
    func testEthereumAddressFromPrivateKeyGeneration() {
        let privateKey = try! PrivateKey(pk: "df02cbea58239744a8a6ba328056309ae43f86fec6db45e5f782adcf38aacadf", coin: .ethereum)
    ...
    func testLitecoinAddressFromPrivateKeyGeneration() {
        let privateKey = try! PrivateKey(pk: "T3d12aqL7XSNqMojMtqBZGhQ6E93dzrdbnNUKMvdmVTa9TQn4L3m", coin: .litecoin)
    ...
    func testBitcoinCashAddressFromPrivateKeyGeneration() {
        let privateKey = try! PrivateKey(pk: "KwgDcj2ZDN5vzRXsTv1F6vzQV7nx7shEYjFBcWng1sH6Fy9rhK2b", coin: .bitcoinCash)
